...
public class BlockOreTungsten extends Block implements IHasModel 
{
	public BlockOreTungsten(String name, Material material) 
	{
		super(material);
	...
	{
		return ville.mod.init.ItemInit.TUNGSTEN;
	}
