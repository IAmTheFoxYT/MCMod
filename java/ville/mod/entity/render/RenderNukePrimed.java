...
public class RenderNukePrimed extends Render<EntityNukePrimed>
{
    ...
    public void doRender(EntityNukePrimed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        blockrendererdispatcher.renderBlockBrightness(BlockInit.NUKE.getDefaultState(), entity.getBrightness());
        ...
        if (this.renderOutlines)
        {
            ...
            blockrendererdispatcher.renderBlockBrightness(BlockInit.NUKE.getDefaultState(), 1.0F);
